...
<template>
    ...
    <div class="lg:pl-72">
        <div
            class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 dark:border-gray-700 dark:bg-gray-900"
        >
            <button
                type="button"
            ...
            <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                ...
                <div class="flex items-center gap-x-4 lg:gap-x-6">
                    ...
                    <Menu as="div" class="relative">
                        ...
                        >
                            <MenuItems
                                class="absolute right-0 z-10 mt-4 w-40 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none dark:bg-gray-900"
                            >
